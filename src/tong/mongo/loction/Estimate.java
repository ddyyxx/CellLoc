...
public class Estimate{
	public void StreetEstimate(MapLoc mymp,Car car,Vector<Node> orbit,long preline,boolean USEGPS){//返回匹配道路 基站定位或GPS定位
	...
	public void StreetEstimate(MapLoc mymp,Car car,Vector<Node> TaStreet,Vector<Node> GpsStreet,long preline){
		Graph Dij=new Graph(mymp);
		MapLoc newmap = new MapLoc();
		Dij.MapSimple(mymp,newmap);
